...
zErrorCode bufBlockHeaderError = ZERROR_CODE_NONE; \
...
{ \
    ...
    if (bufBlockHeaderError != ZERROR_CODE_NONE) \
    { break; } \
...
internal zErrorCode BufBlock_Validate(BufferBlock *block)
{
    if (block == NULL)
    {
